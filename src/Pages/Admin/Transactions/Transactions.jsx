        ...
        <div>
            ...
            <div className="bg-white m-4 p-5 shadow-sm rounded-sm">
                ...
                <div className="flex justify-between items-center gap-3 flex-wrap pb-2 border-b border-b-slate-300">
                    <h2 className="text-lg md:text-xl font-bold flex items-center gap-1"><BiTransferAlt className="mt-1" />Transactions</h2>
                    ...
                    <dialog id="my_modal_1" className="modal">
                        <div className="modal-box p-4 relative bg-white">
                            ...
                            <form onSubmit={handleSearchByDate} className="pt-4">
                                ...
                                <p className="mt-4"><span className="text-red-600 font-semibold"><FaExclamationCircle className="inline" /> Special Note: </span>If no dates are selected, list will be made on today&apos;s date.</p>
