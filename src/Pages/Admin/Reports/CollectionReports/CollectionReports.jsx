                            ...
                            <form onSubmit={handleSearchByDate} className="pt-4">
                                <div className="flex gap-5">
                                    <div className="w-1/2">
                                        ...
                                        <input type="date" className="w-full mt-2  border border-slate-300" name="fromDate" id="from" />
                                    </div>
                                    <div className="w-1/2">
                                        <label htmlFor="to" className="font-bold">To Date</label>
                                        <input type="date" className="w-full mt-2  border border-slate-300" name="toDate" id="to" />
                                    </div>
                                </div>
