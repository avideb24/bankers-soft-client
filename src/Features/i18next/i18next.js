            ...
            translation: {
                ...
                Wallet: {
                    ...
                    Loans: {
                        ...
                        lastPayment: 'Last Payment ',
                        nextDate: 'Next Date',
                        tenor: 'Possible tenor of the loan:',
                        to: 'to',
                        collection: 'Collection',
                        fullPay: 'Full Pay',
                        loanCollection: 'Loan Collection',
                    ...
                    Modals: {
                        ...
                        Deposit: {
                            ...
                            selectDate: 'Select Date',
                            amount: 'Amount',
                            acountActivated: 'Account Activated!',
                            installments: ' Installments',
                        },
                        Withdraw: {
                            withdraw: 'Withdraw',
                            ...
                            ifYou : 'If you close the account at this time',
                            customerWillReceive  : 'Customer will receive',
                            totalLoss  : 'Will be a total loss',
                        },
                    },
                },
                Documents: {
        ...
        bn: {
            translation: {
                ...
                Wallet: {
                    ...
                    transactions: 'লেনদেন',
                    Shared: {
                        shareDetails: 'শেয়ারের তথ্য',
                        fixedDepositDetails: 'স্থায়ী আমানত বিবরণ',
                        dpsDetails: 'ডিপিএস তথ্য',
                        amount: 'পরিমান ',
                        duration: 'মেয়াদ ',
                        interest: 'লাভ',
                        openingDate: ' নিবন্ধনের তারিখ ',
                        hascrossed: ' অতিক্রম করেছে ',
                        lastPayment: ' সর্বশেষ লেনদেন ',
                        nextDate: 'পরবর্তী তারিখ ',
                        installments: 'কিস্তি সংখ্যা ',
                        monthlyAmount: 'মাসিক পেমেন্ট ',
                        expired: 'মেয়াদ শেষ ',
                        savingsInterest: 'সঞ্চয় ইন্টারেস্ট',
                    },
                    Loans: {
                        currentLoans: 'চলমান ঋণ ',
                        savings: ' সঞ্চয়',
                        loanId: 'ঋণ আইডি ',
                        loanGroup: 'ঋণ গ্রুপ ',
                        accountNo: 'হিসাব নং ',
                        installmentDue  : 'বকেয়া কিস্তি  ',
                        loanAmount: 'ঋণের পরিমান ',
                        installments: 'কিস্তি সংখ্যা ',
                        perInstallment: 'প্রতি কিস্তি ',
                        remainingLoan: 'ঋণ বকেয়া',
                        lastPayment: 'সর্বশেষ লেনদেন ',
                        nextDate: 'পরবর্তী তারিখ ',
                        tenor: 'ঋণের সম্ভাব্য মেয়াদ:',
                        to: 'হতে',
                        collection: 'আদায়',
                        fullPay: 'সম্পূর্ণ গ্রহন',
                        loanCollection: 'ঋণ আদায়',
                        date: 'তারিখ',
                        fine: 'জরিমানা',
                    ...
                    Modals: {
                        payInterest: ' লাভ প্রদান করুন',
                        savingsInterest: 'সঞ্চয় ইন্টারেস্ট',
                        interest: 'লাভ',
                        totalDays: 'মোট দিন ',
                        updateInterest: 'আপডেট ইন্টারেস্ট',
                        newInterest: 'নতুন ইন্টারেস্ট',
                        update: 'আপডেট',
                        pay: 'জমা দিন',
                        save: 'সেভ',
                        close: 'ক্লোজ',
                        Deposit: {
                            deposit: 'জমা',
                            cancel: 'বাতিল',
                            selectDate: 'তারিখ সিলেক্ট করুন',
                            amount: 'টাকার পরিমান',
                            acountActivated: 'হিসাবটি চালু আছে!',
                            installments: 'কিস্তি সংখ্যা',
                        },
                        Withdraw: {
                            withdraw: 'উত্তোলন',
                            ...
                            interest: 'লাভ',
                            duration: ' মেয়াদ ',
                            interestAmount: 'লাভ পরিমান',
                            totalAmount: 'সর্বমোট',
                            hascrossed: 'অতিক্রম করেছে',
                            amount: 'টাকার পরিমান',
                            currentProfits : 'বর্তমান লাভ',
                            ifYou : 'এই মুহুর্তে হিসাবটি বন্ধ করলে',
                            customerWillReceive  : 'গ্রাহক পাবে',
                            totalLoss  : 'মোট লস হবে',
                        },
                    },
                },
                Documents: {
                ...
                Profile: {
                    Customer: {
                        ...
                        Modal: {
                            ...
                            close: 'ক্লোজ',
                            newLoan: 'নতুন ঋণ',
                            selectGroup: 'গ্রুপ সিলেক্ট করুন',
                            amount: 'টাকার পরিমান',
                            savings: 'সঞ্চয়',
                            interest: 'লাভ',
                            installments: 'কিস্তি',
