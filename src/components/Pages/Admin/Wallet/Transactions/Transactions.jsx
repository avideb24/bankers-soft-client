    ...
    return (
        <div className="bg-white p-5 shadow-sm h-max">
            ...
            <div className="flex justify-between items-center gap-3 pb-3 border-b border-b-slate-300 mb-5">
                <h2 className="flex items-center gap-2 text-base md:text-lg font-bold capitalize"><FaChartBar />{title} {lang.transactions}</h2>

                {/* search btn */}
                <Button text={modal.search} icon={FiSearch} bg="bg-orange-600" handleClick={() => document.getElementById('my_modal_1').showModal()} />
