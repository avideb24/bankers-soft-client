                    ...
                    <form onSubmit={handleUpdateProfile} className="pt-4 space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" className="w-full bg-white px-3 py-1 mt-2 border border-slate-300" name="registrationDate" id="registrationDate" placeholder="Type here..." required />
                            </div>
                        </div>
