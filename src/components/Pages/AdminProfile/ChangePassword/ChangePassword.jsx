...
const ChangePassword = () => {
    ...
    const lang = t('AdminProfile').ChangePassword;
    // --------------------------
    ...
    return (
        <>
            {/* edit profile btn */}
            <button onClick={() => document.getElementById('my_modal_2').showModal()} className="bg-orange-600 px-3 py-1 text-white font-semibold flex items-center gap-2 rounded-sm"><MdLock />{lang.changePassword}</button>
            {/* edit profile modal */}
